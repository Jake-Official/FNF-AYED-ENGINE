...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['Jake Official', "Jake", 'Director + Animator + Composer + Coder + Charter', 'https://www.youtube.com/@Jake_Official0', '333FFF'],
			...
			['Destiny', 'destiny', 'Made The Memes Of Ayed Engine', 'https://www.youtube.com/channel/UCQsoIwiG80AEzGQPB8JzDqw', '3FF38A'],
			['Jona', 'Jona', 'Visuallizer Video Music', '', '00FFFA'],
			['------Discord-----'],
